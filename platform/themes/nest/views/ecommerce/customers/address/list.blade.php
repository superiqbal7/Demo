        ...
        @empty
            <div class="col-12">
                <div class="alert alert-dark d-flex align-items-center" role="alert">
                    ...
                    <div>{!! clean(__('You don\'t have an address book, you can create it <a href=":here">here</a>', ['here' => route('customer.address.create')])) !!}</div>
                </div>
            </div>
        @endforelse
        ...
        <div class="modal-dialog modal-xs">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-small btn-secondary" type="button" data-bs-dismiss="modal">{{ __('Cancel') }}</button>
